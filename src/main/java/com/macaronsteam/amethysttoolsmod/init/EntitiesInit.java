...
public class EntitiesInit {
  ...
  public static void register() {
    ENTITY_AMETHYST_ARROW = register("amethyst_arrow_entity", () -> EntityType.Builder.<AmethystArrowEntity>of(AmethystArrowEntity::new, MobCategory.MISC).sized(0.5F, 0.5F).clientTrackingRange(4).updateInterval(20).build(AmethystToolsMod.MODID + ":amethyst_arrow_entity"), AmethystToolsModConfig.enableAmethystArrows.get());
    ENTITY_AMETHYST_SPECTRAL_ARROW = register("amethyst_spectral_arrow_entity", () -> EntityType.Builder.<AmethystSpectralArrowEntity>of(AmethystSpectralArrowEntity::new, MobCategory.MISC).sized(0.5F, 0.5F).clientTrackingRange(4).updateInterval(20).build(AmethystToolsMod.MODID + ":amethyst_spectral_arrow_entity"), AmethystToolsModConfig.enableAmethystArrows.get(), AmethystToolsModConfig.enableExtraArrows.get());
    ENTITY_AMETHYST_TRIDENT = register("amethyst_trident_entity", () -> EntityType.Builder.<ThrownAmethystTrident>of((type, level) -> new ThrownAmethystTrident(level), MobCategory.MISC).sized(0.5F, 0.5F).clientTrackingRange(4).updateInterval(20).build(AmethystToolsMod.MODID + ":amethyst_trident_entity"));
  }
