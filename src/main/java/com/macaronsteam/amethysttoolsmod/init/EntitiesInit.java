...
public class EntitiesInit {
  public static final DeferredRegister<EntityType<?>> ENTITIES =
      DeferredRegister.create(ForgeRegistries.ENTITIES, AmethystToolsMod.MODID);
  public static RegistryObject<EntityType<AmethystArrowEntity>> ENTITY_AMETHYST_ARROW = register(
      "amethyst_arrow_entity",
      () -> EntityType.Builder.<AmethystArrowEntity>of(AmethystArrowEntity::new, MobCategory.MISC)
          .sized(0.5F, 0.5F).clientTrackingRange(4).updateInterval(20)
          .build(AmethystToolsMod.MODID + ":amethyst_arrow_entity"),
  ...
  public static RegistryObject<EntityType<AmethystSpectralArrowEntity>> ENTITY_AMETHYST_SPECTRAL_ARROW =
      register("amethyst_spectral_arrow_entity",
          () -> EntityType.Builder
              .<AmethystSpectralArrowEntity>of(AmethystSpectralArrowEntity::new, MobCategory.MISC)
              .sized(0.5F, 0.5F).clientTrackingRange(4).updateInterval(20)
              .build(AmethystToolsMod.MODID + ":amethyst_spectral_arrow_entity"),
          AmethystToolsModConfig.enableAmethystArrows.get(),
  ...
  private static <T extends Entity> RegistryObject<EntityType<T>> register(String name,
      Supplier<EntityType<T>> entity, boolean... condition) {
    if (!Booleans.contains(condition, false) && entity != null)
