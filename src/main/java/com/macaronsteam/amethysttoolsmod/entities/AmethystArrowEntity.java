 ...
 **/
package com.macaronsteam.amethysttoolsmod.entities;
...
public class AmethystArrowEntity extends AbstractArrow {
  ...
  public static int getCustomColor(ItemStack stack) {
    ...
    return tag != null && tag.contains("CustomPotionColor", 99) ? tag.getInt("CustomPotionColor")
        : -1;
  }
  ...
  private void updateColor() {
    ...
    if (this.potion == Potions.EMPTY && this.effects.isEmpty()) {
      ...
      this.entityData.set(ID_EFFECT_COLOR,
          PotionUtils.getColor(PotionUtils.getAllEffects(this.potion, this.effects)));
    }
  ...
  public void addEffect(MobEffectInstance mobEffect) {
    ...
    this.getEntityData().set(ID_EFFECT_COLOR,
        PotionUtils.getColor(PotionUtils.getAllEffects(this.potion, this.effects)));
  }
  ...
  public void tick() {
    ...
    } else if (this.inGround && this.inGroundTime != 0 && !this.effects.isEmpty()
  ...
  protected void doPostHurtEffects(LivingEntity living) {
    ...
    for (MobEffectInstance mobEffect : this.potion.getEffects()) {
      living.addEffect(
          new MobEffectInstance(mobEffect.getEffect(), Math.max(mobEffect.getDuration() / 8, 1),
