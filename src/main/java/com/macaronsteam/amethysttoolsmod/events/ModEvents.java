...
public class ModEvents {
	...
	public static void onColorHandlerInit(ColorHandlerEvent.Item event) {
		if (ItemsInit.ITEM_AMETHYST_TIPPED_ARROW != null) event.getItemColors().register((stack, layer) -> layer == 0 ? -1 : PotionUtils.getColor(stack), ItemsInit.ITEM_AMETHYST_TIPPED_ARROW.get());
	}
}